...
exports.dirJXVM = path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH, '.jxvm');
exports.dirVersions = path.join(exports.dirJXVM, "versions");
...
exports.readBinaryInfo = function (jxPath, cb) {
  ...
  jxtools.fs.execMultiple(cmd, function (ret) {
    for (var o in ret) {
