...
exports.displayCommandUsage = function (cmd, str) {
  ...
  if (cmd === "use") {
    ...
    console.log("");
    console.log("The command renames the link to jx binary.");
    console.log("By default JXcore binaries managed by JXVM are available under `jxx`.");
    console.log("You may force to use it under any other name, especially `jx` if you like or `my_jx` etc.");
    console.log("");
    console.log("This command requires sudo on UNIX systems.");
